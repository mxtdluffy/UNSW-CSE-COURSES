...
if __name__ == '__main__':
    ...
    doctest.testmod()
'''
print(is_word_word_ladder('AAA', 'AAA', ['AAA']))
print(is_word_word_ladder('DAY', 'MEW', ['DAY', 'DAW', 'DEW', 'MEW']))
print(is_word_word_ladder('COLD', 'WARM', ['COLD', 'CALD', 'CARD', 'WARD', 'WARM']))
print(is_word_word_ladder('COLD', 'WARM', ['COLD', 'CORD', 'WORD', 'WARD', 'WARP', 'WARM']))
print(is_word_word_ladder('TABLE', 'TABLE', ['TABLE']))
print(is_word_word_ladder('DAY', 'MEW', ['DAY', 'HAY', 'HEY', 'HEW', 'MEW']))
print(is_word_word_ladder('COLD', 'WARM', ['COLD', 'CORD', 'WORD', 'WARD', 'WARM']))
